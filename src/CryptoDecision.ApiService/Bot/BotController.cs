    ...
    IFeatureRepository   featureRepo) : ControllerBase
{
    ...
    public async Task<IActionResult> Start([FromBody] BotStartRequest req, CancellationToken ct = default)
    {
        ...
        var opts = new BotOptions
        {
            ...
            CapitalUsd               = req.CapitalUsd > 0 ? req.CapitalUsd : 30m,
            MaxOpenTradesPerStrategy = req.MaxOpenTradesPerStrategy > 0 ? req.MaxOpenTradesPerStrategy : 1,
            ...
            CooldownSeconds          = req.CooldownSeconds > 0 ? req.CooldownSeconds : 900,
            MaxHoldMinutes           = 720,
...
public sealed record BotStartRequest(
    ...
    decimal      CapitalUsd               = 30m,
    decimal      PositionPct              = 0.10m,
    decimal      TakeProfitPct            = 0.02m,
    decimal      StopLossPct              = 0.015m,
    int          CooldownSeconds          = 900,
    int          MaxOpenTradesPerStrategy = 1,
